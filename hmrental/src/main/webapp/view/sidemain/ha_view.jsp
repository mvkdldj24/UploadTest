...
.txt {padding: 0;height: 62px;background: #f6f6f6;border-top: 1px solid #ddd;border-bottom: 1px solid #ddd;
...
<div class="container text-center">
	<div class="row text-center" >
		<c:forEach var="i" items="${ha_list}">
			<div class="col-lg-3 col-md-6 mb-4" style="width: 292px; margin-bottom: 40px;">
				<div class="card h-100" style="border: 1px solid gray;">
					<c:url value="/sidemain/dtview/ha/${i.P_NUM}" var="dtv" />
					<form action="${dtv}" method="get">
						<input type="hidden" name="HA_CODE" value="${i.HA_CODE}"/>
						<button style="border : 0px; padding: 0; width: 259px;">
						<img class="card-img-top" src="${pageContext.request.contextPath}/img/HA/${i.P_PHOTO}" />
						<div class="txt">
							<b class="name">${i.P_NAME}</b>
						</div></button>	
					</form>
				</div>
			</div>
